...
//        URL = window.UEDITOR_HOME_URL||"/gzszlwiki/ueditor/";tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
...
//        ,imagePath:"http://gzszlwiki-upload.stor.sinaapp.com/"                    //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置  
        	,imagePath:"http://szlwiki-fileupload.stor.sinaapp.com/" 
...
//        ,scrawlPath:"http://gzszlwiki-upload.stor.sinaapp.com/"
        ,scrawlPath:"http://szlwiki-fileupload.stor.sinaapp.com/"
        
        //附件上传配置区
        ,fileUrl:URL+"jsp/fileUp.jsp"               //附件上传提交地址
//        ,filePath:URL + "jsp/"                   //附件修正地址，同imagePath
//        ,filePath:"http://gzszlwiki-upload.stor.sinaapp.com/" 
        ,filePath:"http://szlwiki-fileupload.stor.sinaapp.com/" 
...
//        ,catcherPath:"http://gzszlwiki-upload.stor.sinaapp.com/"
        ,catcherPath:"http://szlwiki-fileupload.stor.sinaapp.com/"
...
//        ,imageManagerPath:"http://gzszlwiki-upload.stor.sinaapp.com/"
        ,imageManagerPath:"http://szlwiki-fileupload.stor.sinaapp.com/"
        
        //屏幕截图配置区
        ,snapscreenHost: '1.gzszlwiki.sinaapp.com'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
...
//        ,snapscreenPath:"http://gzszlwiki-upload.stor.sinaapp.com/"
...
//        ,wordImagePath:"http://gzszlwiki-upload.stor.sinaapp.com/"
        ,wordImagePath:"http://szlwiki-fileupload.stor.sinaapp.com/"
